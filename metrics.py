...
class Metrics:
    ...
    def __init__(self, true_positive, true_negative, false_positive, false_negative, metrics=[], filename=None):
        """
        Inizializza la classe Metrics con i valori della matrice di confusione e le metriche specificate

        Parameters:
        true_positive (int): Il numero di veri positivi
        true_negative (int): Il numero di veri negativi
        false_positive (int): Il numero di falsi positivi
        false_negative (int): Il numero di falsi negativi
        metrics (list): La lista delle metriche da calcolare
        filename (str): Il nome del file Excel per salvare i risultati
        """
    ...
    def accuracy(self, confusion_matrix, K=1):
        ...
        Parameters:
        confusion_matrix (list): La matrice di confusione.
        K (int): Il numero di esperimenti.

        Returns:
        float: L'accuratezza media.
        list: I valori di accuratezza per ogni esperimento.
        """
        accuracy_scores = []
        ...
        # Se la matrice di confusione è una lista di liste
        ...
        # Se la matrice di confusione è una lista singola
        else:
    ...
    def error_rate(self, confusion_matrix, K=1):
        ...
        Returns:
        float: Il tasso di errore medio.
        list: I valori di tasso di errore per ogni esperimento.
        """
        error_rate_scores = []
        true_positive = confusion_matrix[0]
        false_positive = confusion_matrix[1]
    ...
    def sensitivity(self, confusion_matrix, K=1):
        ...
        Returns:
        float: La sensibilità media.
        list: I valori di sensibilità per ogni esperimento.
        """
        sensitivity_scores = []
        true_positive = confusion_matrix[0]
        false_positive = confusion_matrix[1]
    ...
    def specificity(self, confusion_matrix, K=1):
        ...
        Returns:
        float: La specificità media.
        list: I valori di specificità per ogni esperimento.
        """
        specificity_scores = []
        true_positive = confusion_matrix[0]
        false_positive = confusion_matrix[1]
    ...
    def geometric_mean(self, confusion_matrix, K=1):
        ...
        Returns:
        float: La media geometrica.
        list: I valori di media geometrica per ogni esperimento.
        """
        ...
        # Calcola la media geometrica media
    ...
    def save_metrics(self, metrics, filename=None):
        ...
        Parameters:
        metrics (dict): Le metriche da salvare.
    ...
    def save_plot_to_excel(self, temp_file, sheet_name):
        ...
        Parameters:
        temp_file (str): Il nome dell'immagine temporanea del plot.
        sheet_name (str): Il nome del foglio in cui salvare il plot.
    ...
    def metrics_plot(self, metrics):
        ...
        Parameters:
        metrics (dict): Le metriche da plottare.
        ...
        self.save_plot_to_excel(temp_file, 'Plot Andamento Metriche')
